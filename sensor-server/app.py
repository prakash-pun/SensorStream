...
def handle_sensor_data(data):
    ...
    sensor_entry = [
        ...
        datetime.utcfromtimestamp(
            data["timestamp"] / 1000).strftime('%Y-%m-%d %H:%M:%S'),
        ...
        round(data["altitudeAccuracy"],
              4) if data["altitudeAccuracy"] else None,
        ...
        round(data["accelerometer"]["x"],
              4) if data["accelerometer"]["x"] else None,
        round(data["accelerometer"]["y"],
              4) if data["accelerometer"]["y"] else None,
        round(data["accelerometer"]["z"],
              4) if data["accelerometer"]["z"] else None,
